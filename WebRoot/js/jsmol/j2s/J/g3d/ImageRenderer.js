...
for (var i = 0, offset = 0, pbufOffset = y * width + x; i < textHeight; i++, pbufOffset += (width - textWidth)) {
for (var j = 0; j < textWidth; j++, pbufOffset++, offset++) if (z < zbuf[pbufOffset]) p.addPixel (pbufOffset, z, buffer[offset]);
