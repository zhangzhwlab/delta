...
g,f)!==a});if(w.nodeType)return g.grep(f,function(f){return f===w!==a});if("string"===typeof w){if(Vc.test(w))return g.filter(w,f,a);w=g.filter(w,f)}return g.grep(f,function(f){return 0<=g.inArray(f,w)!==a})}function d(f,w){do f=f[w];while(f&&1!==f.nodeType);return f}function p(){z.addEventListener?(z.removeEventListener("DOMContentLoaded",s,!1),a.removeEventListener("load",s,!1)):(z.detachEvent("onreadystatechange",s),a.detachEvent("onload",s))}function s(){if(z.addEventListener||"load"===event.type||
"complete"===z.readyState)p(),g.ready()}function r(f,w,a){if(void 0===a&&1===f.nodeType)if(a="data-"+w.replace(Wc,"-$1").toLowerCase(),a=f.getAttribute(a),"string"===typeof a){try{a="true"===a?!0:"false"===a?!1:"null"===a?null:+a+""===a?+a:Xc.test(a)?g.parseJSON(a):a}catch(x){}g.data(f,w,a)}else a=void 0;return a}function b(f){for(var a in f)if(!("data"===a&&g.isEmptyObject(f[a]))&&"toJSON"!==a)return!1;return!0}function e(f,a,n,x){if(g.acceptData(f)){var b=g.expando,j=f.nodeType,c=j?g.cache:f,e=
j?f[b]:f[b]&&b;if(e&&c[e]&&(x||c[e].data)||!(void 0===n&&"string"===typeof a)){e||(e=j?f[b]=m.pop()||g.guid++:b);c[e]||(c[e]=j?{}:{toJSON:g.noop});if("object"===typeof a||"function"===typeof a)x?c[e]=g.extend(c[e],a):c[e].data=g.extend(c[e].data,a);f=c[e];x||(f.data||(f.data={}),f=f.data);void 0!==n&&(f[g.camelCase(a)]=n);"string"===typeof a?(n=f[a],null==n&&(n=f[g.camelCase(a)])):n=f;return n}}}function c(f,a,n){if(g.acceptData(f)){var x,j,c=f.nodeType,e=c?g.cache:f,d=c?f[g.expando]:g.expando;if(e[d]){if(a&&
(x=n?e[d]:e[d].data)){g.isArray(a)?a=a.concat(g.map(a,g.camelCase)):a in x?a=[a]:(a=g.camelCase(a),a=a in x?[a]:a.split(" "));for(j=a.length;j--;)delete x[a[j]];if(n?!b(x):!g.isEmptyObject(x))return}if(!n&&(delete e[d].data,!b(e[d])))return;c?g.cleanData([f],!0):v.deleteExpando||e!=e.window?delete e[d]:e[d]=null}}}function q(){return!0}function B(){return!1}function O(){try{return z.activeElement}catch(f){}}function T(f){var a=mc.split("|");f=f.createDocumentFragment();if(f.createElement)for(;a.length;)f.createElement(a.pop());
return f}function M(f,a){var n,x,b=0,j=typeof f.getElementsByTagName!==ja?f.getElementsByTagName(a||"*"):typeof f.querySelectorAll!==ja?f.querySelectorAll(a||"*"):void 0;if(!j){j=[];for(n=f.childNodes||f;null!=(x=n[b]);b++)!a||g.nodeName(x,a)?j.push(x):g.merge(j,M(x,a))}return void 0===a||a&&g.nodeName(f,a)?g.merge([f],j):j}function rb(f){Nb.test(f.type)&&(f.defaultChecked=f.checked)}function Ka(f,a){return g.nodeName(f,"table")&&g.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?f.getElementsByTagName("tbody")[0]||
f.appendChild(f.ownerDocument.createElement("tbody")):f}function K(f){f.type=(null!==g.find.attr(f,"type"))+"/"+f.type;return f}function da(f){var a=Yc.exec(f.type);a?f.type=a[1]:f.removeAttribute("type");return f}function Wa(f,a){for(var n,x=0;null!=(n=f[x]);x++)g._data(n,"globalEval",!a||g._data(a[x],"globalEval"))}function ya(f,a){if(1===a.nodeType&&g.hasData(f)){var n,x,b;x=g._data(f);var j=g._data(a,x),c=x.events;if(c)for(n in delete j.handle,j.events={},c){x=0;for(b=c[n].length;x<b;x++)g.event.add(a,
n,c[n][x])}j.data&&(j.data=g.extend({},j.data))}}function za(f,w){var n=g(w.createElement(f)).appendTo(w.body),x=a.getDefaultComputedStyle?a.getDefaultComputedStyle(n[0]).display:g.css(n[0],"display");n.detach();return x}function La(f){var a=z,n=nc[f];if(!n){n=za(f,a);if("none"===n||!n)fb=(fb||g("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),a=(fb[0].contentWindow||fb[0].contentDocument).document,a.write(),a.close(),n=za(f,a),fb.detach();nc[f]=n}return n}function pa(f,
a){return{get:function(){var n=f();if(null!=n)if(n)delete this.get;else return(this.get=a).apply(this,arguments)}}}function gb(f,a){if(a in f)return a;for(var n=a.charAt(0).toUpperCase()+a.slice(1),x=a,g=oc.length;g--;)if(a=oc[g]+n,a in f)return a;return x}function A(f,a){for(var n,x,b,j=[],c=0,e=f.length;c<e;c++)if(x=f[c],x.style)if(j[c]=g._data(x,"olddisplay"),n=x.style.display,a)!j[c]&&"none"===n&&(x.style.display=""),""===x.style.display&&hb(x)&&(j[c]=g._data(x,"olddisplay",La(x.nodeName)));else if(!j[c]&&
(b=hb(x),n&&"none"!==n||!b))g._data(x,"olddisplay",b?n:g.css(x,"display"));for(c=0;c<e;c++)if(x=f[c],x.style&&(!a||"none"===x.style.display||""===x.style.display))x.style.display=a?j[c]||"":"none";return f}function V(f,a,n){return(f=Zc.exec(a))?Math.max(0,f[1]-(n||0))+(f[2]||"px"):a}function aa(f,a,n,x,b){a=n===(x?"border":"content")?4:"width"===a?1:0;for(var j=0;4>a;a+=2)"margin"===n&&(j+=g.css(f,n+Ma[a],!0,b)),x?("content"===n&&(j-=g.css(f,"padding"+Ma[a],!0,b)),"margin"!==n&&(j-=g.css(f,"border"+
Ma[a]+"Width",!0,b))):(j+=g.css(f,"padding"+Ma[a],!0,b),"padding"!==n&&(j+=g.css(f,"border"+Ma[a]+"Width",!0,b)));return j}function fa(f,a,n){var x=!0,b="width"===a?f.offsetWidth:f.offsetHeight,j=Na(f),c=v.boxSizing()&&"border-box"===g.css(f,"boxSizing",!1,j);if(0>=b||null==b){b=Oa(f,a,j);if(0>b||null==b)b=f.style[a];if(sb.test(b))return b;x=c&&(v.boxSizingReliable()||b===f.style[a]);b=parseFloat(b)||0}return b+aa(f,a,n||(c?"border":"content"),x,j)+"px"}function C(f,a,n,x,b){return new C.prototype.init(f,
a,n,x,b)}function ua(){setTimeout(function(){Xa=void 0});return Xa=g.now()}function qa(f,a){var n,x={height:f},b=0;for(a=a?1:0;4>b;b+=2-a)n=Ma[b],x["margin"+n]=x["padding"+n]=f;a&&(x.opacity=x.width=f);return x}function ib(f,a,n){for(var b,g=(jb[a]||[]).concat(jb["*"]),j=0,c=g.length;j<c;j++)if(b=g[j].call(n,a,f))return b}function tb(f,a,n){var b,j,c=0,e=ub.length,d=g.Deferred().always(function(){delete t.elem}),t=function(){if(j)return!1;for(var a=Xa||ua(),a=Math.max(0,m.startTime+m.duration-a),
w=1-(a/m.duration||0),n=0,b=m.tweens.length;n<b;n++)m.tweens[n].run(w);d.notifyWith(f,[m,w,a]);if(1>w&&b)return a;d.resolveWith(f,[m]);return!1},m=d.promise({elem:f,props:g.extend({},a),opts:g.extend(!0,{specialEasing:{}},n),originalProperties:a,originalOptions:n,startTime:Xa||ua(),duration:n.duration,tweens:[],createTween:function(a,w){var n=g.Tween(f,m.opts,a,w,m.opts.specialEasing[a]||m.opts.easing);m.tweens.push(n);return n},stop:function(a){var w=0,n=a?m.tweens.length:0;if(j)return this;for(j=
!0;w<n;w++)m.tweens[w].run(1);a?d.resolveWith(f,[m,a]):d.rejectWith(f,[m,a]);return this}});a=m.props;n=m.opts.specialEasing;var q,h,k,u;for(b in a)if(q=g.camelCase(b),h=n[q],k=a[b],g.isArray(k)&&(h=k[1],k=a[b]=k[0]),b!==q&&(a[q]=k,delete a[b]),(u=g.cssHooks[q])&&"expand"in u)for(b in k=u.expand(k),delete a[q],k)b in a||(a[b]=k[b],n[b]=h);else n[q]=h;for(;c<e;c++)if(b=ub[c].call(m,f,a,m.opts))return b;g.map(a,ib,m);g.isFunction(m.opts.start)&&m.opts.start.call(f,m);g.fx.timer(g.extend(t,{elem:f,anim:m,
queue:m.opts.queue}));return m.progress(m.opts.progress).done(m.opts.done,m.opts.complete).fail(m.opts.fail).always(m.opts.always)}function kb(f){return function(a,n){"string"!==typeof a&&(n=a,a="*");var b,j=0,c=a.toLowerCase().match(va)||[];if(g.isFunction(n))for(;b=c[j++];)"+"===b.charAt(0)?(b=b.slice(1)||"*",(f[b]=f[b]||[]).unshift(n)):(f[b]=f[b]||[]).push(n)}}function ra(f,a,n,b){function j(d){var m;c[d]=!0;g.each(f[d]||[],function(f,g){var d=g(a,n,b);if("string"===typeof d&&!e&&!c[d])return a.dataTypes.unshift(d),
j(d),!1;if(e)return!(m=d)});return m}var c={},e=f===Ob;return j(a.dataTypes[0])||!c["*"]&&j("*")}function D(f,a){var n,b,j=g.ajaxSettings.flatOptions||{};for(b in a)void 0!==a[b]&&((j[b]?f:n||(n={}))[b]=a[b]);n&&g.extend(!0,f,n);return f}function W(f,a,n,b){var j;if(g.isArray(a))g.each(a,function(a,w){n||ad.test(f)?b(f,w):W(f+"["+("object"===typeof w?a:"")+"]",w,n,b)});else if(!n&&"object"===g.type(a))for(j in a)W(f+"["+j+"]",a[j],n,b);else b(f,a)}function X(f){try{return f?new a.ActiveXObject("Microsoft.XMLHTTP"):
...
toArray:function(){return y.call(this)},get:function(f){return null!=f?0>f?this[f+this.length]:this[f]:y.call(this)},pushStack:function(f){f=g.merge(this.constructor(),f);f.prevObject=this;f.context=this.context;return f},each:function(f,a){return g.each(this,f,a)},map:function(f){return this.pushStack(g.map(this,function(a,n){return f.call(a,n,a)}))},slice:function(){return this.pushStack(y.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(f){var a=
this.length;f=+f+(0>f?a:0);return this.pushStack(0<=f&&f<a?[this[f]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:F,sort:m.sort,splice:m.splice};g.extend=g.fn.extend=function(){var f,a,n,b,j,c=arguments[0]||{},e=1,d=arguments.length,m=!1;"boolean"===typeof c&&(m=c,c=arguments[e]||{},e++);"object"!==typeof c&&!g.isFunction(c)&&(c={});e===d&&(c=this,e--);for(;e<d;e++)if(null!=(j=arguments[e]))for(b in j)f=c[b],n=j[b],c!==n&&(m&&n&&(g.isPlainObject(n)||(a=g.isArray(n)))?(a?
(a=!1,f=f&&g.isArray(f)?f:[]):f=f&&g.isPlainObject(f)?f:{},c[b]=g.extend(m,f,n)):void 0!==n&&(c[b]=n));return c};g.extend({expando:"jQuery"+("1.11.0"+Math.random()).replace(/\D/g,""),isReady:!0,error:function(f){throw Error(f);},noop:function(){},isFunction:function(f){return"function"===g.type(f)},isArray:Array.isArray||function(f){return"array"===g.type(f)},isWindow:function(f){return null!=f&&f==f.window},isNumeric:function(f){return 0<=f-parseFloat(f)},isEmptyObject:function(f){for(var a in f)return!1;
return!0},isPlainObject:function(f){var a;if(!f||"object"!==g.type(f)||f.nodeType||g.isWindow(f))return!1;try{if(f.constructor&&!Za.call(f,"constructor")&&!Za.call(f.constructor.prototype,"isPrototypeOf"))return!1}catch(n){return!1}if(v.ownLast)for(a in f)return Za.call(f,a);for(a in f);return void 0===a||Za.call(f,a)},type:function(f){return null==f?f+"":"object"===typeof f||"function"===typeof f?Ya[bd.call(f)]||"object":typeof f},globalEval:function(f){f&&g.trim(f)&&(a.execScript||function(f){a.eval.call(a,
f)})(f)},camelCase:function(f){return f.replace(dd,"ms-").replace(ed,P)},nodeName:function(f,a){return f.nodeName&&f.nodeName.toLowerCase()===a.toLowerCase()},each:function(f,a,n){var b,g=0,j=f.length;b=k(f);if(n)if(b)for(;g<j&&!(b=a.apply(f[g],n),!1===b);g++);else for(g in f){if(b=a.apply(f[g],n),!1===b)break}else if(b)for(;g<j&&!(b=a.call(f[g],g,f[g]),!1===b);g++);else for(g in f)if(b=a.call(f[g],g,f[g]),!1===b)break;return f},trim:Pb&&!Pb.call("\ufeff\u00a0")?function(f){return null==f?"":Pb.call(f)}:
function(f){return null==f?"":(f+"").replace(cd,"")},makeArray:function(f,a){var n=a||[];null!=f&&(k(Object(f))?g.merge(n,"string"===typeof f?[f]:f):F.call(n,f));return n},inArray:function(f,a,n){var b;if(a){if(sa)return sa.call(a,f,n);b=a.length;for(n=n?0>n?Math.max(0,b+n):n:0;n<b;n++)if(n in a&&a[n]===f)return n}return-1},merge:function(f,a){for(var n=+a.length,b=0,g=f.length;b<n;)f[g++]=a[b++];if(n!==n)for(;void 0!==a[b];)f[g++]=a[b++];f.length=g;return f},grep:function(f,a,n){for(var b=[],g=0,
j=f.length,c=!n;g<j;g++)n=!a(f[g],g),n!==c&&b.push(f[g]);return b},map:function(f,a,n){var b,g=0,j=f.length,c=[];if(k(f))for(;g<j;g++)b=a(f[g],g,n),null!=b&&c.push(b);else for(g in f)b=a(f[g],g,n),null!=b&&c.push(b);return E.apply([],c)},guid:1,proxy:function(f,a){var n,b;"string"===typeof a&&(b=f[a],a=f,f=b);if(g.isFunction(f))return n=y.call(arguments,2),b=function(){return f.apply(a||this,n.concat(y.call(arguments)))},b.guid=f.guid=f.guid||g.guid++,b},now:function(){return+new Date},support:v});
g.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(f,a){Ya["[object "+a+"]"]=a.toLowerCase()});var Qb=a,H=function(f,a,n,b){var g,j,c,e,d;(a?a.ownerDocument||a:Y)!==R&&ka(a);a=a||R;n=n||[];if(!f||"string"!==typeof f)return n;if(1!==(e=a.nodeType)&&9!==e)return[];if(Z&&!b){if(g=fd.exec(f))if(c=g[1])if(9===e)if((j=a.getElementById(c))&&j.parentNode){if(j.id===c)return n.push(j),n}else return n;else{if(a.ownerDocument&&(j=a.ownerDocument.getElementById(c))&&ta(a,
j)&&j.id===c)return n.push(j),n}else{if(g[2])return Aa.apply(n,a.getElementsByTagName(f)),n;if((c=g[3])&&I.getElementsByClassName&&a.getElementsByClassName)return Aa.apply(n,a.getElementsByClassName(c)),n}if(I.qsa&&(!S||!S.test(f))){j=g=L;c=a;d=9===e&&f;if(1===e&&"object"!==a.nodeName.toLowerCase()){e=vb(f);(g=a.getAttribute("id"))?j=g.replace(gd,"\\$&"):a.setAttribute("id",j);j="[id='"+j+"'] ";for(c=e.length;c--;)e[c]=j+wb(e[c]);c=Rb.test(f)&&Sb(a.parentNode)||a;d=e.join(",")}if(d)try{return Aa.apply(n,
c.querySelectorAll(d)),n}catch(m){}finally{g||a.removeAttribute("id")}}}var t;a:{f=f.replace(xb,"$1");j=vb(f);if(!b&&1===j.length){g=j[0]=j[0].slice(0);if(2<g.length&&"ID"===(t=g[0]).type&&I.getById&&9===a.nodeType&&Z&&G.relative[g[1].type]){a=(G.find.ID(t.matches[0].replace(Ba,Ca),a)||[])[0];if(!a){t=n;break a}f=f.slice(g.shift().value.length)}for(e=yb.needsContext.test(f)?0:g.length;e--;){t=g[e];if(G.relative[c=t.type])break;if(c=G.find[c])if(b=c(t.matches[0].replace(Ba,Ca),Rb.test(g[0].type)&&
Sb(a.parentNode)||a)){g.splice(e,1);f=b.length&&wb(g);if(!f){Aa.apply(n,b);t=n;break a}break}}}Da(f,j)(b,a,!Z,n,Rb.test(f)&&Sb(a.parentNode)||a);t=n}return t},Tb=function(){function f(n,b){a.push(n+" ")>G.cacheLength&&delete f[a.shift()];return f[n+" "]=b}var a=[];return f},la=function(f){f[L]=!0;return f},ma=function(f){var a=R.createElement("div");try{return!!f(a)}catch(n){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}},Ub=function(f,a){for(var n=f.split("|"),b=f.length;b--;)G.attrHandle[n[b]]=
a},pc=function(f,a){var n=a&&f,b=n&&1===f.nodeType&&1===a.nodeType&&(~a.sourceIndex||ba)-(~f.sourceIndex||ba);if(b)return b;if(n)for(;n=n.nextSibling;)if(n===a)return-1;return f?1:-1},hd=function(f){return function(a){return"input"===a.nodeName.toLowerCase()&&a.type===f}},id=function(f){return function(a){var n=a.nodeName.toLowerCase();return("input"===n||"button"===n)&&a.type===f}},U=function(f){return la(function(a){a=+a;return la(function(n,b){for(var g,j=f([],n.length,a),c=j.length;c--;)if(n[g=
j[c]])n[g]=!(b[g]=n[g])})})},Sb=function(f){return f&&typeof f.getElementsByTagName!==ga&&f},qc=function(){},vb=function(f,a){var n,b,g,j,c,e,d;if(c=Ea[f+" "])return a?0:c.slice(0);c=f;e=[];for(d=G.preFilter;c;){if(!n||(b=jd.exec(c)))b&&(c=c.slice(b[0].length)||c),e.push(g=[]);n=!1;if(b=kd.exec(c))n=b.shift(),g.push({value:n,type:b[0].replace(xb," ")}),c=c.slice(n.length);for(j in G.filter)if((b=yb[j].exec(c))&&(!d[j]||(b=d[j](b))))n=b.shift(),g.push({value:n,type:j,matches:b}),c=c.slice(n.length);
if(!n)break}return a?c.length:c?H.error(f):Ea(f,e).slice(0)},wb=function(f){for(var a=0,n=f.length,b="";a<n;a++)b+=f[a].value;return b},Vb=function(f,a,n){var b=a.dir,g=n&&"parentNode"===b,j=ld++;return a.first?function(a,n,w){for(;a=a[b];)if(1===a.nodeType||g)return f(a,n,w)}:function(a,n,w){var c,e,d=[ca,j];if(w)for(;a=a[b];){if((1===a.nodeType||g)&&f(a,n,w))return!0}else for(;a=a[b];)if(1===a.nodeType||g){e=a[L]||(a[L]={});if((c=e[b])&&c[0]===ca&&c[1]===j)return d[2]=c[2];e[b]=d;if(d[2]=f(a,n,
w))return!0}}},Wb=function(f){return 1<f.length?function(a,n,b){for(var g=f.length;g--;)if(!f[g](a,n,b))return!1;return!0}:f[0]},Pa=function(f,a,n,b,g){for(var j,c=[],e=0,d=f.length,m=null!=a;e<d;e++)if(j=f[e])if(!n||n(j,b,g))c.push(j),m&&a.push(e);return c},$a=function(f,a,n,b,g,j){b&&!b[L]&&(b=$a(b));g&&!g[L]&&(g=$a(g,j));return la(function(j,c,e,d){var m,t,Ja=[],q=[],k=c.length,h;if(!(h=j)){h=a||"*";for(var u=e.nodeType?[e]:e,p=[],y=0,B=u.length;y<B;y++)H(h,u[y],p);h=p}h=f&&(j||!a)?Pa(h,Ja,f,e,
d):h;u=n?g||(j?f:k||b)?[]:c:h;n&&n(h,u,e,d);if(b){m=Pa(u,q);b(m,[],e,d);for(e=m.length;e--;)if(t=m[e])u[q[e]]=!(h[q[e]]=t)}if(j){if(g||f){if(g){m=[];for(e=u.length;e--;)if(t=u[e])m.push(h[e]=t);g(null,u=[],m,d)}for(e=u.length;e--;)if((t=u[e])&&-1<(m=g?Qa.call(j,t):Ja[e]))j[m]=!(c[m]=t)}}else u=Pa(u===c?u.splice(k,u.length):u),g?g(null,c,u,d):Aa.apply(c,u)})},ab=function(f){var a,n,b,g=f.length,j=G.relative[f[0].type];n=j||G.relative[" "];for(var c=j?1:0,e=Vb(function(f){return f===a},n,!0),d=Vb(function(f){return-1<
Qa.call(a,f)},n,!0),m=[function(f,n,b){return!j&&(b||n!==Ra)||((a=n).nodeType?e(f,n,b):d(f,n,b))}];c<g;c++)if(n=G.relative[f[c].type])m=[Vb(Wb(m),n)];else{n=G.filter[f[c].type].apply(null,f[c].matches);if(n[L]){for(b=++c;b<g&&!G.relative[f[b].type];b++);return $a(1<c&&Wb(m),1<c&&wb(f.slice(0,c-1).concat({value:" "===f[c-2].type?"*":""})).replace(xb,"$1"),n,c<b&&ab(f.slice(c,b)),b<g&&ab(f=f.slice(b)),b<g&&wb(f))}m.push(n)}return Wb(m)},Q,I,G,Sa,rc,Da,Ra,na,wa,ka,R,ha,Z,S,ea,Fa,ta,L="sizzle"+-new Date,
Y=Qb.document,ca=0,ld=0,sc=Tb(),Ea=Tb(),xa=Tb(),u=function(f,a){f===a&&(wa=!0);return 0},ga="undefined",ba=-2147483648,oa={}.hasOwnProperty,N=[],bb=N.pop,md=N.push,Aa=N.push,tc=N.slice,Qa=N.indexOf||function(f){for(var a=0,n=this.length;a<n;a++)if(this[a]===f)return a;return-1},uc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),vc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+uc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
Xb=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+vc.replace(3,8)+")*)|.*)\\)|)",xb=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),jd=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,kd=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,nd=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),od=RegExp(Xb),pd=RegExp("^"+uc+"$"),yb={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,
...
"i")},qd=/^(?:input|select|textarea|button)$/i,rd=/^h\d$/i,lb=/^[^{]+\{\s*\[native \w/,fd=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Rb=/[+~]/,gd=/'|\\/g,Ba=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),Ca=function(f,a,n){f="0x"+a-65536;return f!==f||n?a:0>f?String.fromCharCode(f+65536):String.fromCharCode(f>>10|55296,f&1023|56320)};try{Aa.apply(N=tc.call(Y.childNodes),Y.childNodes),N[Y.childNodes.length].nodeType}catch(Yd){Aa={apply:N.length?function(f,a){md.apply(f,tc.call(a))}:
function(f,a){for(var n=f.length,b=0;f[n++]=a[b++];);f.length=n-1}}}I=H.support={};rc=H.isXML=function(f){return(f=f&&(f.ownerDocument||f).documentElement)?"HTML"!==f.nodeName:!1};ka=H.setDocument=function(f){var a=f?f.ownerDocument||f:Y;f=a.defaultView;if(a===R||9!==a.nodeType||!a.documentElement)return R;R=a;ha=a.documentElement;Z=!rc(a);f&&f!==f.top&&(f.addEventListener?f.addEventListener("unload",function(){ka()},!1):f.attachEvent&&f.attachEvent("onunload",function(){ka()}));I.attributes=ma(function(f){f.className=
"i";return!f.getAttribute("className")});I.getElementsByTagName=ma(function(f){f.appendChild(a.createComment(""));return!f.getElementsByTagName("*").length});I.getElementsByClassName=lb.test(a.getElementsByClassName)&&ma(function(f){f.innerHTML="<div class='a'></div><div class='a i'></div>";f.firstChild.className="i";return 2===f.getElementsByClassName("i").length});I.getById=ma(function(f){ha.appendChild(f).id=L;return!a.getElementsByName||!a.getElementsByName(L).length});I.getById?(G.find.ID=function(f,
a){if(typeof a.getElementById!==ga&&Z){var b=a.getElementById(f);return b&&b.parentNode?[b]:[]}},G.filter.ID=function(f){var a=f.replace(Ba,Ca);return function(f){return f.getAttribute("id")===a}}):(delete G.find.ID,G.filter.ID=function(f){var a=f.replace(Ba,Ca);return function(f){return(f=typeof f.getAttributeNode!==ga&&f.getAttributeNode("id"))&&f.value===a}});G.find.TAG=I.getElementsByTagName?function(f,a){if(typeof a.getElementsByTagName!==ga)return a.getElementsByTagName(f)}:function(f,a){var b,
...
f.querySelectorAll(":checked").length||S.push(":checked")}),ma(function(f){var b=a.createElement("input");b.setAttribute("type","hidden");f.appendChild(b).setAttribute("name","D");f.querySelectorAll("[name=d]").length&&S.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");f.querySelectorAll(":enabled").length||S.push(":enabled",":disabled");f.querySelectorAll("*,:x");S.push(",.*:")});(I.matchesSelector=lb.test(Fa=ha.webkitMatchesSelector||ha.mozMatchesSelector||ha.oMatchesSelector||ha.msMatchesSelector))&&
...
f)-Qa.call(na,b):0;if(g===c)return pc(f,b);for(g=f;g=g.parentNode;)e.unshift(g);for(g=b;g=g.parentNode;)d.unshift(g);for(;e[j]===d[j];)j++;return j?pc(e[j],d[j]):e[j]===Y?-1:d[j]===Y?1:0};return a};H.matches=function(f,a){return H(f,null,null,a)};H.matchesSelector=function(f,a){(f.ownerDocument||f)!==R&&ka(f);a=a.replace(nd,"='$1']");if(I.matchesSelector&&Z&&(!ea||!ea.test(a))&&(!S||!S.test(a)))try{var n=Fa.call(f,a);if(n||I.disconnectedMatch||f.document&&11!==f.document.nodeType)return n}catch(b){}return 0<
H(a,R,null,[f]).length};H.contains=function(f,a){(f.ownerDocument||f)!==R&&ka(f);return ta(f,a)};H.attr=function(f,a){(f.ownerDocument||f)!==R&&ka(f);var n=G.attrHandle[a.toLowerCase()],n=n&&oa.call(G.attrHandle,a.toLowerCase())?n(f,a,!Z):void 0;return void 0!==n?n:I.attributes||!Z?f.getAttribute(a):(n=f.getAttributeNode(a))&&n.specified?n.value:null};H.error=function(f){throw Error("Syntax error, unrecognized expression: "+f);};H.uniqueSort=function(f){var a,n=[],b=0,g=0;wa=!I.detectDuplicates;na=
!I.sortStable&&f.slice(0);f.sort(u);if(wa){for(;a=f[g++];)a===f[g]&&(b=n.push(g));for(;b--;)f.splice(n[b],1)}na=null;return f};Sa=H.getText=function(f){var a,b="",g=0;if(a=f.nodeType)if(1===a||9===a||11===a){if("string"===typeof f.textContent)return f.textContent;for(f=f.firstChild;f;f=f.nextSibling)b+=Sa(f)}else{if(3===a||4===a)return f.nodeValue}else for(;a=f[g++];)b+=Sa(a);return b};G=H.selectors={cacheLength:50,createPseudo:la,match:yb,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0},
...
function(a,b,n){var w,m,t,q,h;b=c!==e?"nextSibling":"previousSibling";var k=a.parentNode,u=d&&a.nodeName.toLowerCase();n=!n&&!d;if(k){if(c){for(;b;){for(m=a;m=m[b];)if(d?m.nodeName.toLowerCase()===u:1===m.nodeType)return!1;h=b="only"===f&&!h&&"nextSibling"}return!0}h=[e?k.firstChild:k.lastChild];if(e&&n){n=k[L]||(k[L]={});w=n[f]||[];q=w[0]===ca&&w[1];t=w[0]===ca&&w[2];for(m=q&&k.childNodes[q];m=++q&&m&&m[b]||(t=q=0)||h.pop();)if(1===m.nodeType&&++t&&m===a){n[f]=[ca,q,t];break}}else if(n&&(w=(a[L]||
(a[L]={}))[f])&&w[0]===ca)t=w[1];else for(;m=++q&&m&&m[b]||(t=q=0)||h.pop();)if((d?m.nodeName.toLowerCase()===u:1===m.nodeType)&&++t)if(n&&((m[L]||(m[L]={}))[f]=[ca,t]),m===a)break;t-=j;return t===g||0===t%g&&0<=t/g}}},PSEUDO:function(f,a){var b,g=G.pseudos[f]||G.setFilters[f.toLowerCase()]||H.error("unsupported pseudo: "+f);return g[L]?g(a):1<g.length?(b=[f,f,"",a],G.setFilters.hasOwnProperty(f.toLowerCase())?la(function(f,b){for(var n,j=g(f,a),c=j.length;c--;)n=Qa.call(f,j[c]),f[n]=!(b[n]=j[c])}):
function(f){return g(f,0,b)}):g}},pseudos:{not:la(function(f){var a=[],b=[],g=Da(f.replace(xb,"$1"));return g[L]?la(function(f,a,b,n){n=g(f,null,n,[]);for(var w=f.length;w--;)if(b=n[w])f[w]=!(a[w]=b)}):function(f,j,c){a[0]=f;g(a,null,c,b);return!b.pop()}}),has:la(function(f){return function(a){return 0<H(f,a).length}}),contains:la(function(f){return function(a){return-1<(a.textContent||a.innerText||Sa(a)).indexOf(f)}}),lang:la(function(f){pd.test(f||"")||H.error("unsupported lang: "+f);f=f.replace(Ba,
...
a&&"button"===f.type||"button"===a},text:function(f){var a;return"input"===f.nodeName.toLowerCase()&&"text"===f.type&&(null==(a=f.getAttribute("type"))||"text"===a.toLowerCase())},first:U(function(){return[0]}),last:U(function(f,a){return[a-1]}),eq:U(function(f,a,b){return[0>b?b+a:b]}),even:U(function(f,a){for(var b=0;b<a;b+=2)f.push(b);return f}),odd:U(function(f,a){for(var b=1;b<a;b+=2)f.push(b);return f}),lt:U(function(f,a,b){for(a=0>b?b+a:b;0<=--a;)f.push(a);return f}),gt:U(function(f,a,b){for(b=
0>b?b+a:b;++b<a;)f.push(b);return f})}};G.pseudos.nth=G.pseudos.eq;for(Q in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})G.pseudos[Q]=hd(Q);for(Q in{submit:!0,reset:!0})G.pseudos[Q]=id(Q);qc.prototype=G.filters=G.pseudos;G.setFilters=new qc;Da=H.compile=function(f,a){var b,g=[],j=[],c=xa[f+" "];if(!c){a||(a=vb(f));for(b=a.length;b--;)c=ab(a[b]),c[L]?g.push(c):j.push(c);var e=0<g.length,d=0<j.length;b=function(f,a,b,n,w){var c,m,t,q=0,h="0",Ja=f&&[],k=[],u=Ra,p=f||d&&G.find.TAG("*",w),y=ca+=
null==u?1:Math.random()||0.1,B=p.length;for(w&&(Ra=a!==R&&a);h!==B&&null!=(c=p[h]);h++){if(d&&c){for(m=0;t=j[m++];)if(t(c,a,b)){n.push(c);break}w&&(ca=y)}e&&((c=!t&&c)&&q--,f&&Ja.push(c))}q+=h;if(e&&h!==q){for(m=0;t=g[m++];)t(Ja,k,a,b);if(f){if(0<q)for(;h--;)!Ja[h]&&!k[h]&&(k[h]=bb.call(n));k=Pa(k)}Aa.apply(n,k);w&&(!f&&0<k.length&&1<q+g.length)&&H.uniqueSort(n)}w&&(ca=y,Ra=u);return Ja};b=e?la(b):b;c=xa(f,b)}return c};I.sortStable=L.split("").sort(u).join("")===L;I.detectDuplicates=!!wa;ka();I.sortDetached=
...
ma(function(f){return null==f.getAttribute("disabled")})||Ub("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",function(f,a,b){var g;if(!b)return!0===f[a]?a.toLowerCase():(g=f.getAttributeNode(a))&&g.specified?g.value:null});g.find=H;g.expr=H.selectors;g.expr[":"]=g.expr.pseudos;g.unique=H.uniqueSort;g.text=H.getText;g.isXMLDoc=H.isXML;g.contains=H.contains;var wc=g.expr.match.needsContext,xc=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Vc=
...
nb=null,Bb,Cb,Ac=z.createElement("div");for(Bb in{submit:!0,change:!0,focusin:!0})if(Cb="on"+Bb,!(v[Bb+"Bubbles"]=Cb in a))Ac.setAttribute(Cb,"t"),v[Bb+"Bubbles"]=!1===Ac.attributes[Cb].expando;var Zb=/^(?:input|select|textarea)$/i,wd=/^key/,xd=/^(?:mouse|contextmenu)|click/,Bc=/^(?:focusinfocus|focusoutblur)$/,Cc=/^([^.]*)(?:\.(.+)|)$/;g.event={global:{},add:function(a,b,j,c,e){var d,m,t,q,h,k,u,p,y;if(t=g._data(a)){j.handler&&(q=j,j=q.handler,e=q.selector);j.guid||(j.guid=g.guid++);if(!(m=t.events))m=
t.events={};if(!(h=t.handle))h=t.handle=function(a){return typeof g!==ja&&(!a||g.event.triggered!==a.type)?g.event.dispatch.apply(h.elem,arguments):void 0},h.elem=a;b=(b||"").match(va)||[""];for(t=b.length;t--;)if(d=Cc.exec(b[t])||[],p=k=d[1],y=(d[2]||"").split(".").sort(),p){d=g.event.special[p]||{};p=(e?d.delegateType:d.bindType)||p;d=g.event.special[p]||{};k=g.extend({type:p,origType:k,data:c,handler:j,guid:j.guid,selector:e,needsContext:e&&g.expr.match.needsContext.test(e),namespace:y.join(".")},
q);if(!(u=m[p]))if(u=m[p]=[],u.delegateCount=0,!d.setup||!1===d.setup.call(a,c,y,h))a.addEventListener?a.addEventListener(p,h,!1):a.attachEvent&&a.attachEvent("on"+p,h);d.add&&(d.add.call(a,k),k.handler.guid||(k.handler.guid=j.guid));e?u.splice(u.delegateCount++,0,k):u.push(k);g.event.global[p]=!0}a=null}},remove:function(a,b,j,c,e){var d,m,t,q,h,k,u,p,y,B,ga,s=g.hasData(a)&&g._data(a);if(s&&(k=s.events)){b=(b||"").match(va)||[""];for(h=b.length;h--;)if(t=Cc.exec(b[h])||[],y=ga=t[1],B=(t[2]||"").split(".").sort(),
y){u=g.event.special[y]||{};y=(c?u.delegateType:u.bindType)||y;p=k[y]||[];t=t[2]&&RegExp("(^|\\.)"+B.join("\\.(?:.*\\.|)")+"(\\.|$)");for(q=d=p.length;d--;)if(m=p[d],(e||ga===m.origType)&&(!j||j.guid===m.guid)&&(!t||t.test(m.namespace))&&(!c||c===m.selector||"**"===c&&m.selector))p.splice(d,1),m.selector&&p.delegateCount--,u.remove&&u.remove.call(a,m);q&&!p.length&&((!u.teardown||!1===u.teardown.call(a,B,s.handle))&&g.removeEvent(a,y,s.handle),delete k[y])}else for(y in k)g.event.remove(a,y+b[h],
j,c,!0);g.isEmptyObject(k)&&(delete s.handle,g._removeData(a,"events"))}},trigger:function(f,b,j,c){var e,d,m,t,q,h,k=[j||z],u=Za.call(f,"type")?f.type:f;q=Za.call(f,"namespace")?f.namespace.split("."):[];m=e=j=j||z;if(!(3===j.nodeType||8===j.nodeType)&&!Bc.test(u+g.event.triggered))if(0<=u.indexOf(".")&&(q=u.split("."),u=q.shift(),q.sort()),d=0>u.indexOf(":")&&"on"+u,f=f[g.expando]?f:new g.Event(u,"object"===typeof f&&f),f.isTrigger=c?2:3,f.namespace=q.join("."),f.namespace_re=f.namespace?RegExp("(^|\\.)"+
q.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,f.result=void 0,f.target||(f.target=j),b=null==b?[f]:g.makeArray(b,[f]),q=g.event.special[u]||{},c||!(q.trigger&&!1===q.trigger.apply(j,b))){if(!c&&!q.noBubble&&!g.isWindow(j)){t=q.delegateType||u;Bc.test(t+u)||(m=m.parentNode);for(;m;m=m.parentNode)k.push(m),e=m;if(e===(j.ownerDocument||z))k.push(e.defaultView||e.parentWindow||a)}for(h=0;(m=k[h++])&&!f.isPropagationStopped();)if(f.type=1<h?t:q.bindType||u,(e=(g._data(m,"events")||{})[f.type]&&g._data(m,"handle"))&&
e.apply(m,b),(e=d&&m[d])&&e.apply&&g.acceptData(m))f.result=e.apply(m,b),!1===f.result&&f.preventDefault();f.type=u;if(!c&&!f.isDefaultPrevented()&&(!q._default||!1===q._default.apply(k.pop(),b))&&g.acceptData(j)&&d&&j[u]&&!g.isWindow(j)){(e=j[d])&&(j[d]=null);g.event.triggered=u;try{j[u]()}catch(p){}g.event.triggered=void 0;e&&(j[d]=e)}return f.result}},dispatch:function(a){a=g.event.fix(a);var b,j,c,e,d=[],m=y.call(arguments);b=(g._data(this,"events")||{})[a.type]||[];var t=g.event.special[a.type]||
{};m[0]=a;a.delegateTarget=this;if(!(t.preDispatch&&!1===t.preDispatch.call(this,a))){d=g.event.handlers.call(this,a,b);for(b=0;(c=d[b++])&&!a.isPropagationStopped();){a.currentTarget=c.elem;for(e=0;(j=c.handlers[e++])&&!a.isImmediatePropagationStopped();)if(!a.namespace_re||a.namespace_re.test(j.namespace))if(a.handleObj=j,a.data=j.data,j=((g.event.special[j.origType]||{}).handle||j.handler).apply(c.elem,m),void 0!==j&&!1===(a.result=j))a.preventDefault(),a.stopPropagation()}t.postDispatch&&t.postDispatch.call(this,
...
this.ownerDocument||this,e=g._data(c,b)-1;e?g._data(c,b,e):(c.removeEventListener(a,j,!0),g._removeData(c,b))}}});g.fn.extend({on:function(a,b,j,c,e){var d,m;if("object"===typeof a){"string"!==typeof b&&(j=j||b,b=void 0);for(d in a)this.on(d,b,j,a[d],e);return this}null==j&&null==c?(c=b,j=b=void 0):null==c&&("string"===typeof b?(c=j,j=void 0):(c=j,j=b,b=void 0));if(!1===c)c=B;else if(!c)return this;1===e&&(m=c,c=function(a){g().off(a);return m.apply(this,arguments)},c.guid=m.guid||(m.guid=g.guid++));
return this.each(function(){g.event.add(this,a,c,j,b)})},one:function(a,b,g,j){return this.on(a,b,g,j,1)},off:function(a,b,j){var c;if(a&&a.preventDefault&&a.handleObj)return c=a.handleObj,g(a.delegateTarget).off(c.namespace?c.origType+"."+c.namespace:c.origType,c.selector,c.handler),this;if("object"===typeof a){for(c in a)this.off(c,b,a[c]);return this}if(!1===b||"function"===typeof b)j=b,b=void 0;!1===j&&(j=B);return this.each(function(){g.event.remove(this,a,j,b)})},trigger:function(a,b){return this.each(function(){g.event.trigger(a,
...
b;this.start=this.now=this.cur();this.end=c;this.unit=d||(g.cssNumber[j]?"":"px")},cur:function(){var a=C.propHooks[this.prop];return a&&a.get?a.get(this):C.propHooks._default.get(this)},run:function(a){var b,j=C.propHooks[this.prop];this.pos=this.options.duration?b=g.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&this.options.step.call(this.elem,this.now,this);j&&j.set?j.set(this):C.propHooks._default.set(this);
return this}};C.prototype.init.prototype=C.prototype;C.propHooks={_default:{get:function(a){if(null!=a.elem[a.prop]&&(!a.elem.style||null==a.elem.style[a.prop]))return a.elem[a.prop];a=g.css(a.elem,a.prop,"");return!a||"auto"===a?0:a},set:function(a){if(g.fx.step[a.prop])g.fx.step[a.prop](a);else a.elem.style&&(null!=a.elem.style[g.cssProps[a.prop]]||g.cssHooks[a.prop])?g.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};C.propHooks.scrollTop=C.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};g.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};g.fx=C.prototype.init;g.fx.step={};var Xa,Ib,Id=/^(?:toggle|show|hide)$/,Kc=RegExp("^(?:([+-])=|)("+Ab+")([a-z%]*)$","i"),Jd=/queueHooks$/,ub=[function(a,b,j){var c,e,d,m,t,q,h=this,u={},k=a.style,p=a.nodeType&&hb(a),y=g._data(a,"fxshow");j.queue||(m=g._queueHooks(a,"fx"),null==m.unqueued&&(m.unqueued=0,t=m.empty.fire,m.empty.fire=function(){m.unqueued||t()}),m.unqueued++,
h.always(function(){h.always(function(){m.unqueued--;g.queue(a,"fx").length||m.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))j.overflow=[k.overflow,k.overflowX,k.overflowY],e=g.css(a,"display"),q=La(a.nodeName),"none"===e&&(e=q),"inline"===e&&"none"===g.css(a,"float")&&(!v.inlineBlockNeedsLayout||"inline"===q?k.display="inline-block":k.zoom=1);j.overflow&&(k.overflow="hidden",v.shrinkWrapBlocks()||h.always(function(){k.overflow=j.overflow[0];k.overflowX=j.overflow[1];k.overflowY=
j.overflow[2]}));for(c in b)if(e=b[c],Id.exec(e)){delete b[c];d=d||"toggle"===e;if(e===(p?"hide":"show"))if("show"===e&&y&&void 0!==y[c])p=!0;else continue;u[c]=y&&y[c]||g.style(a,c)}if(!g.isEmptyObject(u))for(c in y?"hidden"in y&&(p=y.hidden):y=g._data(a,"fxshow",{}),d&&(y.hidden=!p),p?g(a).show():h.done(function(){g(a).hide()}),h.done(function(){var b;g._removeData(a,"fxshow");for(b in u)g.style(a,b,u[b])}),u)b=ib(p?y[c]:0,c,h),c in y||(y[c]=b.start,p&&(b.end=b.start,b.start="width"===c||"height"===
c?1:0))}],jb={"*":[function(a,b){var j=this.createTween(a,b),c=j.cur(),e=Kc.exec(b),d=e&&e[3]||(g.cssNumber[a]?"":"px"),m=(g.cssNumber[a]||"px"!==d&&+c)&&Kc.exec(g.css(j.elem,a)),t=1,q=20;if(m&&m[3]!==d){d=d||m[3];e=e||[];m=+c||1;do t=t||".5",m/=t,g.style(j.elem,a,m+d);while(t!==(t=j.cur()/c)&&1!==t&&--q)}e&&(m=j.start=+m||+c||0,j.unit=d,j.end=e[1]?m+(e[1]+1)*e[2]:+e[2]);return j}]};g.Animation=g.extend(tb,{tweener:function(a,b){g.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var j,c=0,e=a.length;c<
...
j.getElementsByTagName("parsererror").length)&&g.error("Invalid XML: "+b);return j};var Va,Ia,Od=/#.*$/,Mc=/([?&])_=[^&]*/,Pd=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Qd=/^(?:GET|HEAD)$/,Rd=/^\/\//,Nc=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Oc={},Ob={},Pc="*/".concat("*");try{Ia=location.href}catch(ae){Ia=z.createElement("a"),Ia.href="",Ia=Ia.href}Va=Nc.exec(Ia.toLowerCase())||[];g.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:Ia,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Va[1]),
global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Pc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":g.parseJSON,"text xml":g.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?D(D(a,
g.ajaxSettings),b):D(g.ajaxSettings,a)},ajaxPrefilter:kb(Oc),ajaxTransport:kb(Ob),ajax:function(a,b){function j(a,b,f,c){var e,u,n,l;l=b;if(2!==ba){ba=2;t&&clearTimeout(t);h=void 0;m=c||"";E.readyState=0<a?4:0;c=200<=a&&300>a||304===a;if(f){n=k;for(var w=E,N,oa,r,F,O=n.contents,x=n.dataTypes;"*"===x[0];)x.shift(),void 0===oa&&(oa=n.mimeType||w.getResponseHeader("Content-Type"));if(oa)for(F in O)if(O[F]&&O[F].test(oa)){x.unshift(F);break}if(x[0]in f)r=x[0];else{for(F in f){if(!x[0]||n.converters[F+
" "+x[0]]){r=F;break}N||(N=F)}r=r||N}r?(r!==x[0]&&x.unshift(r),n=f[r]):n=void 0}a:{f=k;N=n;oa=E;r=c;var bb,v,T,w={},O=f.dataTypes.slice();if(O[1])for(v in f.converters)w[v.toLowerCase()]=f.converters[v];for(F=O.shift();F;)if(f.responseFields[F]&&(oa[f.responseFields[F]]=N),!T&&(r&&f.dataFilter)&&(N=f.dataFilter(N,f.dataType)),T=F,F=O.shift())if("*"===F)F=T;else if("*"!==T&&T!==F){v=w[T+" "+F]||w["* "+F];if(!v)for(bb in w)if(n=bb.split(" "),n[1]===F&&(v=w[T+" "+n[0]]||w["* "+n[0]])){!0===v?v=w[bb]:
!0!==w[bb]&&(F=n[0],O.unshift(n[1]));break}if(!0!==v)if(v&&f["throws"])N=v(N);else try{N=v(N)}catch(sa){n={state:"parsererror",error:v?sa:"No conversion from "+T+" to "+F};break a}}n={state:"success",data:N}}if(c)k.ifModified&&((l=E.getResponseHeader("Last-Modified"))&&(g.lastModified[d]=l),(l=E.getResponseHeader("etag"))&&(g.etag[d]=l)),204===a||"HEAD"===k.type?l="nocontent":304===a?l="notmodified":(l=n.state,e=n.data,u=n.error,c=!u);else if(u=l,a||!l)l="error",0>a&&(a=0);E.status=a;E.statusText=
(b||l)+"";c?B.resolveWith(p,[e,l,E]):B.rejectWith(p,[E,l,u]);E.statusCode(s);s=void 0;q&&y.trigger(c?"ajaxSuccess":"ajaxError",[E,k,c?e:u]);ga.fireWith(p,[E,l]);q&&(y.trigger("ajaxComplete",[E,k]),--g.active||g.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var c,e,d,m,t,q,h,u,k=g.ajaxSetup({},b),p=k.context||k,y=k.context&&(p.nodeType||p.jquery)?g(p):g.event,B=g.Deferred(),ga=g.Callbacks("once memory"),s=k.statusCode||{},l={},N={},ba=0,oa="canceled",E={readyState:0,getResponseHeader:function(a){var b;
...
ga.add;E.success=E.done;E.error=E.fail;k.url=((a||k.url||Ia)+"").replace(Od,"").replace(Rd,Va[1]+"//");k.type=b.method||b.type||k.method||k.type;k.dataTypes=g.trim(k.dataType||"*").toLowerCase().match(va)||[""];null==k.crossDomain&&(c=Nc.exec(k.url.toLowerCase()),k.crossDomain=!(!c||!(c[1]!==Va[1]||c[2]!==Va[2]||(c[3]||("http:"===c[1]?"80":"443"))!==(Va[3]||("http:"===Va[1]?"80":"443")))));k.data&&(k.processData&&"string"!==typeof k.data)&&(k.data=g.param(k.data,k.traditional));ra(Oc,k,b,E);if(2===
ba)return E;(q=k.global)&&0===g.active++&&g.event.trigger("ajaxStart");k.type=k.type.toUpperCase();k.hasContent=!Qd.test(k.type);d=k.url;k.hasContent||(k.data&&(d=k.url+=(kc.test(d)?"&":"?")+k.data,delete k.data),!1===k.cache&&(k.url=Mc.test(d)?d.replace(Mc,"$1_="+jc++):d+(kc.test(d)?"&":"?")+"_="+jc++));k.ifModified&&(g.lastModified[d]&&E.setRequestHeader("If-Modified-Since",g.lastModified[d]),g.etag[d]&&E.setRequestHeader("If-None-Match",g.etag[d]));(k.data&&k.hasContent&&!1!==k.contentType||b.contentType)&&
E.setRequestHeader("Content-Type",k.contentType);E.setRequestHeader("Accept",k.dataTypes[0]&&k.accepts[k.dataTypes[0]]?k.accepts[k.dataTypes[0]]+("*"!==k.dataTypes[0]?", "+Pc+"; q=0.01":""):k.accepts["*"]);for(e in k.headers)E.setRequestHeader(e,k.headers[e]);if(k.beforeSend&&(!1===k.beforeSend.call(p,E,k)||2===ba))return E.abort();oa="abort";for(e in{success:1,error:1,complete:1})E[e](k[e]);if(h=ra(Ob,k,b,E)){E.readyState=1;q&&y.trigger("ajaxSend",[E,k]);k.async&&0<k.timeout&&(t=setTimeout(function(){E.abort("timeout")},
...
X()||X(1)};var Vd=0,Lb={},Mb=g.ajaxSettings.xhr();if(a.ActiveXObject)g(a).on("unload",function(){for(var a in Lb)Lb[a](void 0,!0)});v.cors=!!Mb&&"withCredentials"in Mb;(Mb=v.ajax=!!Mb)&&g.ajaxTransport(function(a){if(!a.crossDomain||v.cors){var b;return{send:function(j,c){var e,d=a.xhr(),m=++Vd;console.log("xhr.open async="+a.async+" url="+a.url);d.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(e in a.xhrFields)d[e]=a.xhrFields[e];a.mimeType&&d.overrideMimeType&&d.overrideMimeType(a.mimeType);
!a.crossDomain&&!j["X-Requested-With"]&&(j["X-Requested-With"]="XMLHttpRequest");for(e in j)void 0!==j[e]&&d.setRequestHeader(e,j[e]+"");d.send(a.hasContent&&a.data||null);b=function(j,e){var t,k,q;if(b&&(e||4===d.readyState))if(delete Lb[m],b=void 0,d.onreadystatechange=g.noop,e)4!==d.readyState&&d.abort();else{q={};t=d.status;"string"===typeof d.responseText&&(q.text=d.responseText);try{k=d.statusText}catch(h){k=""}!t&&a.isLocal&&!a.crossDomain?t=q.text?200:404:1223===t&&(t=204)}q&&c(t,k,q,d.getAllResponseHeaders())};
...
b.left-d.left+c);"using"in b?b.using.call(a,q):t.css(q)}};g.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){g.offset.setOffset(this,a,b)});var b,j,c={top:0,left:0},e=(j=this[0])&&j.ownerDocument;if(e){b=e.documentElement;if(!g.contains(b,j))return c;typeof j.getBoundingClientRect!==ja&&(c=j.getBoundingClientRect());j=t(e);return{top:c.top+(j.pageYOffset||b.scrollTop)-(b.clientTop||0),left:c.left+(j.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}}},position:function(){if(this[0]){var a,
...
g.fn.andSelf=g.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return g});var Wd=a.jQuery,Xd=a.$;g.noConflict=function(b){a.$===g&&(a.$=Xd);b&&a.jQuery===g&&(a.jQuery=Wd);return g};typeof l===ja&&(a.jQuery=a.$=g);return g});
(function(a){function l(a){try{return a?new window.ActiveXObject("Microsoft.XMLHTTP"):new window.XMLHttpRequest}catch(h){}}a.ajaxSettings.xhr=void 0===window.ActiveXObject?l:function(){return(this.url==document.location||0==this.url.indexOf("http")||!this.isLocal)&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&l()||l(1)};a.ajaxTransport("+script",function(a){var h,d=document.head||jQuery("head")[0]||document.documentElement;return{send:function(p,s){h=document.createElement("script");a.scriptCharset&&
(h.charset=a.scriptCharset);h.src=a.url;h.onload=h.onreadystatechange=function(a,b){if(b||!h.readyState||/loaded|complete/.test(h.readyState))h.onload=h.onreadystatechange=null,h.parentNode&&h.parentNode.removeChild(h),h=null,b||s(200,"success")};d.insertBefore(h,d.firstChild)},abort:function(){if(h)h.onload(void 0,!0)}}});a.extend(a.support,{iecors:!!window.XDomainRequest});a.support.iecors?a.ajaxTransport(function(a){return{send:function(h,d){var p=new window.XDomainRequest;p.onload=function(){d(200,
"OK",{text:p.responseText},{"Content-Type":p.contentType})};a.xhrFields&&(p.onerror=a.xhrFields.error,p.ontimeout=a.xhrFields.timeout);p.open(a.type,a.url);p.send(a.hasContent&&a.data||null)},abort:function(){xdr.abort()}}}):(a.ajaxSetup({accepts:{binary:"text/plain; charset=x-user-defined"},responseFields:{binary:"response"}}),a.ajaxTransport("binary",function(a){var h;return{send:function(d,p){var s=a.xhr();console.log("xhr.open binary async="+a.async+" url="+a.url);s.open(a.type,a.url,a.async);
...
s.responseText:null}catch(q){}try{d.binary=s.response}catch(l){}try{c=s.statusText}catch(r){c=""}!b&&a.isLocal&&!a.crossDomain?b=d.text?200:404:1223===b&&(b=204);p(b,c,d,e)}}catch(da){alert(da),p(-1,da)}};a.async?4===s.readyState?setTimeout(h):s.onreadystatechange=h:h()},abort:function(){}}}))})(jQuery);
(function(a,l,k,h){function d(d,k){function r(c){a(b).each(function(){self.Jmol&&(0<=k.indexOf("mouseup")||0<=k.indexOf("touchend"))&&Jmol._setMouseOwner(null);var b=a(this);this!==c.target&&!b.has(c.target).length&&b.triggerHandler(k,[c.target,c])})}k=k||d+h;var b=a(),e=d+"."+k+"-special-event";a.event.special[k]={setup:function(){b=b.add(this);1===b.length&&a(l).bind(e,r)},teardown:function(){self.Jmol&&Jmol._setMouseOwner(null);b=b.not(this);0===b.length&&a(l).unbind(e)},add:function(a){var b=
...
l._isMsie=void 0!==window.ActiveXObject;l._useDataURI=!l._isSafari&&!l._isMsie;for(var k in Jmol)l[k]=Jmol[k];return l}(document,Jmol));
...
d.prop(e,c):d.prop(e)};a.$remove=function(b){return a._$(b).remove()};a.$scrollTo=function(b,e){var c=a._$(b);return c.scrollTop(0>e?c[0].scrollHeight:e)};a.$setEnabled=function(b,e){return a._$(b).attr("disabled",e?null:"disabled")};a.$setSize=function(b,e,c){return a._$(b).width(e).height(c)};a.$setVisible=function(b,e){var c=a._$(b);return e?c.show():c.hide()};a.$submit=function(b){return a._$(b).submit()};a.$val=function(b,e){var c=a._$(b);return 1==arguments.length?c.val():c.val(e)};a._clearVars=
function(){delete jQuery;delete l;delete a;delete SwingController;delete J;delete JM;delete JS;delete JSV;delete JU;delete JV;delete java;delete javajs;delete Clazz;delete c$};var k=document,h=window,d={};d.ua=navigator.userAgent.toLowerCase();var p;a:{p=["linux","unix","mac","win"];for(var s=p.length;s--;)if(-1!=d.ua.indexOf(p[s])){p=p[s];break a}p="unknown"}d.os=p;d.browser=function(){for(var a=d.ua,e="konqueror webkit omniweb opera webtv icab msie mozilla".split(" "),c=0;c<e.length;c++)if(0<=a.indexOf(e[c]))return e[c];
...
(k=e.substring(0,1),e=e.substring(1)):k=b._hasOptions?a.$val(a.$(b,"select")):"$";"="==k&&3==e.length&&(e="="+e);var h=k+e;if(e&&!(0>h.indexOf("?")&&h==b._thisJmolModel)){b._thisJmolModel=h;var p;d&&null!=b._viewSet&&null!=(p=a.View.__findView(b._viewSet,{chemID:h}))?a.View.__setView(p,b,!1):("$"==k||":"==k?b._jmolFileType="MOL":"="==k&&(b._jmolFileType="PDB"),b._searchDatabase(e,k,c))}};a._searchDatabase=function(b,e,c,d){b._showInfo(!1);return 0<=e.indexOf("?")?(a._getInfoFromDatabase(b,c,e.split("?")[0]),
...
a._alertNoBinary&&!b&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=!1}return!0};a._binaryTypes=".gz .jpg .gif .png .zip .jmol .bin .smol .spartan .mrc .pse .map .omap".split(" ");a._isBinaryUrl=function(b){for(var e=a._binaryTypes.length;0<=--e;)if(0<=b.indexOf(a._binaryTypes[e]))return!0;return!1};a._getFileData=function(b,e,c){var d=a._isBinaryUrl(b),k=0<=b.indexOf("pdb.gz")&&0==b.indexOf("http://www.rcsb.org/pdb/files/"),h=d&&!a._canSyncBinary(k);
h&&k&&(b=b.replace(/pdb\.gz/,"pdb"),h=d=!1);k=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var p=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),s=a._isDirectCall(b),l=!p&&a.$supportsIECrossDomainScripting(),r=null;if((!e||h)&&(l||h||!p&&!s))r=a._getRawDataFromServer("_",b,e,e,h,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var K={dataType:d?"binary":"text",async:!!e};k?(K.type="POST",K.url=
...
e.indexOf(".")&&0<=b.indexOf(e))return!0;return!1};a._cleanFileData=function(a){return 0<=a.indexOf("\r")&&0<=a.indexOf("\n")?a.replace(/\r\n/g,"\n"):0<=a.indexOf("\r")?a.replace(/\r/g,"\n"):a};a._getFileType=function(a){var e=a.substring(0,1);if("$"==e||":"==e)return"MOL";if("="==e)return"="==a.substring(1,2)?"LCIF":"PDB";a=a.split(".").pop().toUpperCase();return a.substring(0,Math.min(a.length,3))};a._getZ=function(b,e){return b&&b._z&&b._z[e]||a._z[e]};a._incrZ=function(b,e){return b&&b._z&&++b._z[e]||
...
k||b._canvas.height!=e))b._newCanvas(!0),b._appletPanel.setDisplay(b._canvas);b._appletPanel.setScreenDimension(k,e);k=function(){b._appletPanel.paint?b._appletPanel.paint(null):b._appletPanel.update(null)};d?setTimeout(k):k()}};a._getHiddenCanvas=function(a,b,d,e,k){b=a._id+"_"+b;(a=document.getElementById(b))&&k&&(a=null);a||(a=document.createElement("canvas"));a.width=a.style.width=d;a.height=a.style.height=e;a.id!=b&&(a.id=b);return a};a._loadImage=function(b,d,e,k,h){var p=d[1];if(null==h)return h=
new Image,h.onload=function(){a._loadImage(b,d,null,k,h)},null!=e&&(e=J.io.Base64.getBase64(e).toString(),e=p.substring(url.lastIndexOf("/")+1),0<=e.indexOf(".png")||e.indexOf(".jpg")),h.src=p,!0;e=h.width;var s=h.height,l="echo_"+d[0],r=a._getHiddenCanvas(b.vwr.html5Applet,l,e,s,!0);r.imageWidth=e;r.imageHeight=s;r.id=l;r.image=h;a._setCanvasImage(r,e,s);k(r,p)};a._setCanvasImage=function(a,b,d){a.buf32=null;a.width=b;a.height=d;a.getContext("2d").drawImage(a.image,0,0,b,d)}})(Jmol);
...
l._addScript=function(a,h){var d=l._scripts.length;l._scripts[d]=[a,h];return d};l._getIdForControl=function(a,h){return"string"==typeof a?a:!h||!a._canScript||a._canScript(h)?a._id:null};l._radio=function(a,h,d,p,s,r,b,e){var c=l._getIdForControl(a,h);if(null==c)return null;++l._radioCount;void 0!=r&&null!=r||(r="jmolRadioGroup"+(l._radioGroupCount-1));if(!h)return"";void 0!=b&&null!=b||(b="jmolRadio"+(l._radioCount-1));void 0!=d&&null!=d||(d=h.substring(0,32));s||(s="");a="</span>";l._actions[b]=
l._addScript(c,h);h='<span id="span_'+b+'"'+(e?' title="'+e+'"':"")+"><input name='"+r+"' id='"+b+"' type='radio' onclick='Jmol.controls._click(this);return true;' onmouseover='Jmol.controls._mouseOver(this);return true;' onmouseout='Jmol.controls._mouseOut()' "+(p?"checked='true' ":"")+l._radioCssText+" />";0<=d.toLowerCase().indexOf("<td>")&&(h+=a,a="");return h+('<label for="'+b+'">'+d+"</label>"+a+s)};l._scriptExecute=function(k,h){var d=a._applets[h[0]],l=h[1];if("object"==typeof l)l[0](k,l,
d);else"function"==typeof l?l(d):a.script(d,l)};l.__checkScript=function(a,h){var d=0<=h.value.indexOf("JSCONSOLE ")||""===a._scriptCheck(h.value);h.style.color=d?"black":"red";return d};l.__getCmd=function(a,h){if(h._cmds&&h._cmds.length){var d=h._cmds[h._cmdpt=(h._cmdpt+h._cmds.length+a)%h._cmds.length];setTimeout(function(){h.value=d},10);h._cmdadd=1;h._cmddir=a}};l._commandKeyPress=function(k,h,d){k=13==k?13:window.event?window.event.keyCode:k?k.keyCode||k.which:0;var p=document.getElementById(h),
s=a._applets[d];switch(k){case 13:return h=p.value,l._scriptExecute(p,[d,h]),p._cmds||(p._cmds=[],p._cmddir=0,p._cmdpt=-1,p._cmdadd=0),h&&0==p._cmdadd?(++p._cmdpt,p._cmds.splice(p._cmdpt,0,h),p._cmdadd=0,p._cmddir=0):p._cmdadd=0,p.value="",!1;case 27:return setTimeout(function(){p.value=""},20),!1;case 38:l.__getCmd(-1,p);break;case 40:l.__getCmd(1,p);break;default:p._cmdadd=0}setTimeout(function(){l.__checkScript(s,p)},20);return!0};l._click=function(a,h){l._element=a;1==arguments.length&&(h=l._actions[a.id]);
l._scriptExecute(a,l._scripts[h])};l._menuSelected=function(a){var h=a.value;if(void 0!=h)l._scriptExecute(a,l._scripts[h]);else{h=a.length;if("number"==typeof h)for(var d=0;d<h;++d)if(a[d].selected){l._click(a[d],a[d].value);return}alert("?Que? menu selected bug #8734")}};l._cbNotifyMaster=function(a){var h=!0,d=!0,p;for(p in a.chkGroup)a.chkGroup[p].checked?d=!1:h=!1;h&&(a.chkMaster.checked=!0);d&&(a.chkMaster.checked=!1);(h||d)&&l._checkboxItems[a.chkMaster.id]&&l._cbNotifyMaster(l._checkboxItems[a.chkMaster.id])};
l._cbNotifyGroup=function(a,h){for(var d in a.chkGroup){var p=a.chkGroup[d];p.checked!=h&&(p.checked=h,l._cbClick(p));l._checkboxMasters[p.id]&&l._cbNotifyGroup(l._checkboxMasters[p.id],h)}};l._cbSetCheckboxGroup=function(a,h,d){var p=a;"number"==typeof p&&(p="jmolCheckbox"+p);(a=document.getElementById(p))||alert("jmolSetCheckboxGroup: master checkbox not found: "+p);var s=l._checkboxMasters[p]={};s.chkMaster=a;s.chkGroup={};"string"==typeof h?(h=d,p=1):p=0;for(a=p;a<h.length;a++)p=h[a],"number"==
typeof p&&(p="jmolCheckbox"+p),(checkboxItem=document.getElementById(p))||alert("jmolSetCheckboxGroup: group checkbox not found: "+p),s.chkGroup[p]=checkboxItem,l._checkboxItems[p]=s};l._cbClick=function(a){l._control=a;var h=l._actions[a.id][0],d=l._actions[a.id][1];l._click(a,a.checked?h:d);l._checkboxMasters[a.id]&&l._cbNotifyGroup(l._checkboxMasters[a.id],a.checked);l._checkboxItems[a.id]&&l._cbNotifyMaster(l._checkboxItems[a.id])};l._cbOver=function(a){var h=l._actions[a.id][0],d=l._actions[a.id][1];
window.status=l._scripts[a.checked?d:h]};l._mouseOver=function(a,h){1==arguments.length&&(h=l._actions[a.id]);window.status=l._scripts[h]};l._mouseOut=function(){window.status=" ";return!0};l._onloadResetForms=function(){l._hasResetForms||(l._hasResetForms=!0,l._previousOnloadHandler=window.onload,window.onload=function(){if(0<l._buttonCount+l._checkboxCount+l._menuCount+l._radioCount+l._radioGroupCount)for(var a=document.forms,h=a.length;0<=--h;)a[h].reset();l._previousOnloadHandler&&l._previousOnloadHandler()})};
l._getButton=function(k,h,d,p,s){k=l._getIdForControl(k,h);if(null==k)return"";void 0!=p&&null!=p||(p="jmolButton"+l._buttonCount);void 0!=d&&null!=d||(d=h.substring(0,32));++l._buttonCount;l._actions[p]=l._addScript(k,h);h='<span id="span_'+p+'"'+(s?' title="'+s+'"':"")+"><input type='button' name='"+p+"' id='"+p+"' value='"+d+"' onclick='Jmol.controls._click(this)' onmouseover='Jmol.controls._mouseOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+l._buttonCssText+" /></span>";a._debugAlert&&
alert(h);return a._documentWrite(h)};l._getCheckbox=function(k,h,d,p,s,r,b){var e=l._getIdForControl(k,h);null!=e&&(e=l._getIdForControl(k,d));if(null==e)return"";void 0!=r&&null!=r||(r="jmolCheckbox"+l._checkboxCount);++l._checkboxCount;if(void 0==h||null==h||void 0==d||null==d)alert("jmolCheckbox requires two scripts");else if(void 0==p||null==p)alert("jmolCheckbox requires a label");else return l._actions[r]=[l._addScript(e,h),l._addScript(e,d)],k="</span>",s='<span id="span_'+r+'"'+(b?' title="'+
b+'"':"")+"><input type='checkbox' name='"+r+"' id='"+r+"' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+(s?"checked='true' ":"")+l._checkboxCssText+" />",0<=p.toLowerCase().indexOf("<td>")&&(s+=k,k=""),s+='<label for="'+r+'">'+p+"</label>"+k,a._debugAlert&&alert(s),a._documentWrite(s)};l._getCommandInput=function(k,h,d,p,s,r){k=l._getIdForControl(k,"x");if(null==k)return"";void 0!=p&&null!=p||(p="jmolCmd"+l._cmdCount);
void 0!=h&&null!=h||(h="Execute");void 0!=d&&!isNaN(d)||(d=60);void 0!=r||(r="help");++l._cmdCount;h='<span id="span_'+p+'"'+(s?' title="'+s+'"':"")+"><input name='"+p+"' id='"+p+"' size='"+d+"' onkeydown='return Jmol.controls._commandKeyPress(event,\""+p+'","'+k+"\")' value='"+r+"'/><input  type='button' name='"+p+"Btn' id='"+p+"Btn' value = '"+h+"' onclick='Jmol.controls._commandKeyPress(13,\""+p+'","'+k+"\")' /></span>";a._debugAlert&&alert(h);return a._documentWrite(h)};l._getLink=function(k,
h,d,p,s){k=l._getIdForControl(k,h);if(null==k)return"";void 0!=p&&null!=p||(p="jmolLink"+l._linkCount);void 0!=d&&null!=d||(d=h.substring(0,32));++l._linkCount;h=l._addScript(k,h);d='<span id="span_'+p+'"'+(s?' title="'+s+'"':"")+"><a name='"+p+"' id='"+p+"' href='javascript:Jmol.controls._click(null,"+h+");' onmouseover='Jmol.controls._mouseOver(null,"+h+");return true;' onmouseout='Jmol.controls._mouseOut()' "+l._linkCssText+">"+d+"</a></span>";a._debugAlert&&alert(d);return a._documentWrite(d)};
l._getMenu=function(k,h,d,p,s){var r=l._getIdForControl(k,null);void 0!=p&&null!=p||(p="jmolMenu"+l._menuCount);++l._menuCount;r=typeof h;if(null!=r&&"object"==r&&h.length){var b=h.length;"number"!=typeof d||1==d?d=null:0>d&&(d=b);d='<span id="span_'+p+'"'+(s?' title="'+s+'"':"")+"><select name='"+p+"' id='"+p+"' onChange='Jmol.controls._menuSelected(this)'"+(d?" size='"+d+"' ":"")+l._menuCssText+">";for(p=0;p<b;++p){var e=h[p],r=typeof e,c=null,q=s=null;"object"==r&&null!=e?(c=e[0],s=e[1],q=e[2]):
c=s=e;r=l._getIdForControl(k,c);if(null==r)return"";null==s&&(s=c);"#optgroup"==c?d+="<optgroup label='"+s+"'>":"#optgroupEnd"==c?d+="</optgroup>":(r=l._addScript(r,c),d+="<option value='"+r+(q?"' selected='true'>":"'>")+s+"</option>")}d+="</select></span>";a._debugAlert&&alert(d);return a._documentWrite(d)}};l._getRadio=function(k,h,d,p,s,r,b,e){0==l._radioGroupCount&&++l._radioGroupCount;r||(r="jmolRadioGroup"+(l._radioGroupCount-1));k=l._radio(k,h,d,p,s,r,b?b:r+"_"+l._radioCount,e?e:0);if(null==
k)return"";a._debugAlert&&alert(k);return a._documentWrite(k)};l._getRadioGroup=function(k,h,d,p,s,r){var b=typeof h;if("object"!=b||null==b||!h.length)alert("invalid arrayOfRadioButtons");else{void 0!=d&&null!=d||(d="&#xa0; ");var e=h.length;++l._radioGroupCount;p||(p="jmolRadioGroup"+(l._radioGroupCount-1));for(var c="<span id='"+(s?s:p)+"'>",q=0;q<e;++q){q==e-1&&(d="");var B=h[q],b=typeof B,O=null,c="object"==b?c+(O=l._radio(k,B[0],B[1],B[2],d,p,3<B.length?B[3]:(s?s:p)+"_"+q,4<B.length?B[4]:0,
r)):c+(O=l._radio(k,B,null,null,d,p,(s?s:p)+"_"+q,r));if(null==O)return""}c+="</span>";a._debugAlert&&alert(c);return a._documentWrite(c)}}})(Jmol);
...
a.restoreOrientation=function(a,h){return a._restoreOrientation(h)};a.restoreOrientationDelayed=function(a,h,d){return a._restoreOrientationDelayed(h,d)};a.saveOrientation=function(a,h){return a._saveOrientation(h)};a.say=function(a){alert(a)};a.clearConsole=function(a){a._clearConsole()};a.getInfo=function(a){return a._info};a.setInfo=function(a,h,d){a._info=h;2<arguments.length&&a._showInfo(d)};a.showInfo=function(a,h){a._showInfo(h)};a.show2d=function(a,h){a._show2d(h)};a.jmolBr=function(){return a._documentWrite("<br />")};
...
d;){if(e.implementz)for(var h=e.implementz,k=0;k<h.length;k++){var l=a.equalsOrExtendsLevel(h[k],c);if(0<=l)return d+l+1}e=e.superClazz;if(!e)return c===Object||c===a._O?d+1.5:-1;d++}return d};a.instanceOf=function(b,c){return null!=b&&c&&(b==c||b instanceof c||0<=a.getInheritedLevel(a.getClassName(b),c))};a.superCall=function(b,c,d,h){var k=null,l=-1,p=b[d];if(p)if(p.claxxOwner)p.claxxOwner!==c&&(k=p);else if(!p.stacks&&(!p.lastClaxxRef||!p.lastClaxxRef.prototype[d]||!p.lastClaxxRef.prototype[d].stacks))k=
p;else{var q=p.stacks;q||(q=p.lastClaxxRef.prototype[d].stacks);for(l=q.length;0<=--l;)if(c===q[l]){0<l?(l--,k=q[l].prototype[d]):k=q[0].prototype[d]["\\unknown"];break}else if(0<a.getInheritedLevel(c,q[l])){k=q[l].prototype[d];break}}if(k)return 0==l&&"construct"==d&&(c=p.stacks)&&(!c[0].superClazz&&c[0].con$truct)&&c[0].con$truct.apply(b,[]),k.apply(b,h||[]);if("construct"!=d)throw a.alert(["j2slib","no class found",h.typeString]),new e(b,c,d,a.getParamsType(h).typeString);};a.superConstructor=
...
b.con$truct.stacks.length)};a.defineMethod=function(c,d,k,l){a.assureInnerClass&&a.assureInnerClass(c,k);k.exName=d;l=K(l);var p=c.prototype,q=p[d];a._Loader._checkLoad&&M(c,d,l);if(!q||q.claxxOwner===c&&q.funParams==l)return k.funParams=l,k.claxxOwner=c,k.exClazz=c,p[d]=k;var s=null,r=q.stacks;r||(r=[],s=q,q.claxxOwner&&(r[0]=s.claxxOwner));if(!q.stacks||q.claxxReference!==c){var A=++Wa,q=function(){var c;a:{var j=arguments.callee.claxxReference,d=arguments.callee.methodName;c=arguments;fx=this[d];
var g=a.getParamsType(c);if(!fx)try{System.out.println(a.getStackTrace(5))}catch(k){}if(h){var m=A+" "+j.__CLASS_NAME__+" "+d+" "+JSON.stringify(g);0>da.indexOf(m)&&(da+=m+"\n");h[m]||(h[m]=0);h[m]++}if(fx.lastParams==g.typeString&&fx.lastClaxxRef===j){if(g.hasCastedNull){j=[];for(d=0;d<c.length;d++)j[d]=c[d]instanceof a.CastedNull?null:c[d]}else j=c;c=fx.lastMethod?fx.lastMethod.apply(this,j):null}else{fx.lastParams=g.typeString;fx.lastClaxxRef=j;m=fx.stacks;m||(m=j.prototype[d].stacks);for(var t=
!1,l=m.length;0<=--l;)if(t||m[l]===j){var p=m[l].prototype[d],y=g,t=c,q=fx,E=[],s=!0,r=void 0;for(r in p)if(92==r.charCodeAt(0)){var F=r.substring(1).split("\\");F.length==y.length&&E.push(F);s=!1}else if(s&&"funParams"==r&&p.funParams){r=p.funParams;F=r.substring(1).split("\\");F.length==y.length&&(E[0]=F);break}r=void 0;if(!(r=0==E.length)){r=void 0;for(var r=[],sa=E.length,F=0;F<sa;F++){for(var B=[],D=!0,Ya=E[F].length,C=0;C<Ya;C++)if(B[C]=a.getInheritedLevel(y[C],E[F][C]),0>B[C]){D=!1;break}D&&
(B[y.length]=F,r.push(B))}if(0==r.length)r=null;else{sa=r[0];for(F=1;F<r.length;F++){B=!0;for(C=0;C<y.length;C++)if(sa[C]<r[F][C]){B=!1;break}B&&(sa=r[F])}r=E[sa[y.length]].join("\\")}r=!(E=r)}if(r)t=new b;else{p=s?p:p["\\"+E];s=null;if(y.hasCastedNull){s=[];for(y=0;y<t.length;y++)s[y]=t[y]instanceof a.CastedNull?null:t[y]}else s=t;q.lastMethod=p;t=p.apply(this,s)}if(!(t instanceof b)){c=t;break a}t=!0}if("construct"==d)c=void 0;else throw new e(this,j,d,g.typeString);}}return c};q.methodName=d;q.claxxReference=
c;q=p[d]=q;d=[];for(p=0;p<r.length;p++)d[p]=r[p];q.stacks=d}r=q.stacks;0>rb(r,c)&&r.push(c);s&&(s.claxxOwner===c?(q[s.funParams]=s,s.claxxOwner=null,s.funParams=null):s.claxxOwner||(q["\\unknown"]=s));k.exClazz=c;q[l]=k;return q};duplicatedMethods={};var M=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||e.claxxReference)===b)key=b.__CLASS_NAME__+"."+c+d,(b=duplicatedMethods[key])?(c="Warning! Duplicate method found for "+key,System.out.println(c),a.alert(c),duplicatedMethods[key]=b+1):duplicatedMethods[key]=
...
A.STATUS_UNKNOWN=0;A.STATUS_KNOWN=1;A.STATUS_CONTENT_LOADED=2;A.STATUS_MUSTS_LOADED=3;A.STATUS_DECLARED=4;A.STATUS_LOAD_COMPLETE=5;var c=[];b.requireLoaderByBase=function(a){for(var d=0;d<c.length;d++)if(c[d].base==a)return c[d];d=new b;d.base=a;c.push(d);return d};var d=new A,e={},h=0,k=6,p=navigator.userAgent.toLowerCase(),q=-1!=p.indexOf("opera"),r=-1!=p.indexOf("msie")&&!q,s=-1!=p.indexOf("gecko");if(q&&(k=1,q=p.indexOf("opera/"),-1!=q)){var v=9;try{v=parseFloat(p.subString(q+6))}catch(g){}9.6<=
...
typeof g)return a.evalType(c);System.out.println("loadClass "+c);H("java")&&b.loadPackage("java");H("core")&&b.loadPackage("core");b.keepOnLoading=!0;if(!h&&(M&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(ea)))Fa.push([c,g]),System.out.println("loadclass-queuing"+c+ea+" "+isClassDefined(ea));else if((l=isClassDefined(c))||O["@"+c]){if(l&&g&&(h=Q(c),!h||h.status>=A.STATUS_LOAD_COMPLETE))k?window.setTimeout(g,25):g()}else{var m=b.getClasspathFor(c);l=e[m];if(!l)for(k=
C.length;0<=--k;)if(C[k].path==m||C[k].name==c){l=!0;break}if(l){if(g&&(l=Q(c)))if(l.onLoaded){if(g!=l.onLoaded){var p=l.onLoaded,q=g;l.onLoaded=function(){p();q()}}}else l.onLoaded=g}else{l=a.unloadedClasses[c]&&Q(c)||new A;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;Z(m,c,l);l.onLoaded=g;l.status=A.STATUS_KNOWN;c=!1;for(k=C.length;0<=--k;)if(C[k].status!=A.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(k=C.length;0<=--k&&!C[k].isPackage;)C[k+1]=C[k];C[++k]=l}else c&&
...
d;k&&alert("WHY>>");e[d]=!0;Ka(C,d);L=!0;ta=!1;b._checkLoad&&System.out.println("\t"+d+(g?"\n -- required by "+g:"")+"  ajax="+L+" async="+ta);b.onScriptLoading(d);if(L&&!ta){g=l._getFileData(d);try{T(d,g)}catch(p){alert(p+" loading file "+d+" "+c.name+" "+a.getStackTrace())}m&&m()}else System.out.println("for file "+d+" fSuccess = "+(m?m.toString():"")),c={dataType:"script",async:!0,type:"GET",url:d,success:da(d,!1,m),error:da(d,!0,m)},h++,l.$ajax(c)},da=function(c,d,e){a.getStackTrace();return function(){s&&
this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<h&&h--;this.onerror=this.onload=null;d&&alert("There was a problem loading "+c);b.onScriptLoaded(c,!0);var a=this,g;g=e?function(){X(a);aa(c,e)}:function(){X(a);aa(c)};0<=Y?window.setTimeout(function(){aa(c,g)},Y):aa(c,g)}},U=!0,fa=!1,aa=function(c,g){var l=K["@"+c];if(l){var m,p=P["$"+c];if(p)for(var q=0;q<p.length;q++){var s=p[q];if(s!=l.name&&(m=Q(s)))m.status<A.STATUS_CONTENT_LOADED&&(m.status=A.STATUS_CONTENT_LOADED,
updateNode(m));else{m=new A;m.name=s;var v=P["#"+s];v||(alert(s+" J2S error in tryToLoadNext"),error("Java2Script implementation error! Please report this bug!"));m.path=v;Z(m.path,s,m);m.status=A.STATUS_CONTENT_LOADED;Ea(d,m,!1);updateNode(m)}}if(l instanceof Array)for(q=0;q<l.length;q++)l[q].status<A.STATUS_CONTENT_LOADED&&(l[q].status=A.STATUS_CONTENT_LOADED,updateNode(l[q]));else if(l.status<A.STATUS_CONTENT_LOADED){m=!1;p=document.getElementsByTagName("SCRIPT");for(q=0;q<p.length;q++)if(r){if(p[q].onreadystatechange&&
p[q].onreadystatechange.path==l.path&&"interactive"==p[q].readyState){m=!0;break}}else if(p[q].onload&&p[q].onload.path==l.path){m=!0;break}m||(l.status=A.STATUS_CONTENT_LOADED,updateNode(l))}if(b.keepOnLoading){q=!0;if(m=G(A.STATUS_KNOWN))for(S(m);h<k&&(m=G(A.STATUS_KNOWN));)S(m);else if(0!=C.length)m=C.shift(),!e[m.path]||0!=C.length||!U||m.musts.length||m.optionals.length?(Ea(d,m,!0),V(m,m.path,m.requiredBy,!1)):U&&(U=!1);else if(m=I(A.STATUS_KNOWN))for(S(m);h<k&&(m=I(A.STATUS_KNOWN));)S(m);else q=
!1;if(!(q||0<h)){l=[G,I];p=null;for(q=0;2>q;q++)for(;m=l[q](A.STATUS_CONTENT_LOADED);)1==q&&p===m&&(m.status=A.STATUS_LOAD_COMPLETE),updateNode(m),p=m;for(;!(pa=[],!qa(d,c)););for(q=0;2>q;q++)for(p=null;(m=l[q](A.STATUS_DECLARED))&&p!==m;)updateNode(p=m);p=[];for(q=0;2>q;q++)for(;m=l[q](A.STATUS_DECLARED);)p.push(m),m.status=A.STATUS_LOAD_COMPLETE;if(p.length){for(q=0;q<p.length;q++)xa(p[q]);for(q=0;q<p.length;q++)if(l=p[q].onLoaded)p[q].onLoaded=null,l()}if(g)g();else if(b._classCountPending)for(s in b._classPending){if(m=
...
e=d;0<=--e;){var g=a.musts[e];g.requiredBy=a;if(g.status<A.STATUS_DECLARED&&isClassDefined(g.name)){var j=[];g.status=A.STATUS_LOAD_COMPLETE;xa(g);if(g.declaration&&g.declaration.clazzList){for(var h=0,k=g.declaration.clazzList,m=k.length;h<m;h++){var l=Q(k[h]);l&&(l.status!=A.STATUS_LOAD_COMPLETE&&l!==g)&&(l.status=g.status,l.declaration=null,xa(l),l.onLoaded&&j.push(l))}g.declaration=null}g.onLoaded&&j.push(g);for(h=0;h<j.length;h++)if(k=j[h].onLoaded)j[h].onLoaded=null,k()}else g.status==A.STATUS_CONTENT_LOADED&&
...
--c;)Ka(b[c].musts,a)||Ka(b[c].optionals,a)};b.unloadClassExt=function(a){B&&(B[a]=!1);if(P["#"+a]){var c=P["#"+a];P["#"+a]=null;var d=P["$"+c];Ka(d,a)&&(P["$"+c]=d)}if(c=Q(a))c.status=A.STATUS_KNOWN,e[c.path]=!1;c=b.getClasspathFor(a);e[c]=!1;ka[c]&&(ka[c]=!1);b.onClassUnloaded(a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var V=a._LoaderProgressMonitor,aa=null,fa=0,C=null,ua=0;V.DEFAULT_OPACITY=l&&l._j2sLoadMonitorOpacity?l._j2sLoadMonitorOpacity:
...
0<a?a:999999};D.maxLatency=40;D.setMaxLatency=function(a){D.maxLatency=0<a?a:40};D.pinning=!1;D.enablePinning=function(a){D.pinning=a};D.linesCount=0;D.metLineBreak=!1;D.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};var X=String.fromCharCode(160),X=X+(X+X+X);D.consoleOutput=function(a,b){var c=window["j2s.lib"];(c=c&&c.console)&&"string"==typeof c&&(c=document.getElementById(c));
if(!c)return!1;if(D.linesCount>D.maxTotalLines){for(var d=0;d<D.linesCount-D.maxTotalLines;d++)c&&0<c.childNodes.length&&c.removeChild(c.childNodes[0]);D.linesCount=D.maxTotalLines}var e=!1;a=("undefined"==typeof a?"":null==a?"null":""+a).replace(/\t/g,X);if(0<a.length)switch(a.charAt(a.length-1)){case "\n":case "\r":a=1<a.length?a.substring(0,a.length-("\r"==a.charAt(a.length-2)?2:1)):"",e=!0}var h=null;a=a.replace(/\t/g,X);for(var h=a.split(/\r\n|\r|\n/g),d=0,k=h.length-1;d<=k;d++){var l=null;if(D.metLineBreak||
